...
(function() {
    ...
    label.innerHTML =  '<div class="btn-chat-rooom" style="cursor: pointer; text-align:center; background-color: rgb(63, 139, 190);color:white; width:65px;position:fixed; width: 182px;height: 50px; line-height: 50px;bottom: 0px;right: 50px;display: block;">聊天交流<span style="">(2)</span></div>'
